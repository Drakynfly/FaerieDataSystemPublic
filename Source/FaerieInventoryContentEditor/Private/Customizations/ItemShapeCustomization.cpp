...
void FItemShapeCustomization::CustomizeChildren(const TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
    ...
    // Add symmetry toggle
    TSharedPtr<IPropertyHandle> SymmetryHandle = StructHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FFaerieGridShape, bIsSymmetrical));
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        {
                            return IsCellSelected(CellCoord) ? FLinearColor(0.2f, 0.8f, 0.3f) : FLinearColor(0.15f, 0.15f, 0.15f);
                        })
                        .HAlign(HAlign_Fill)
                        .VAlign(VAlign_Fill)
                    ]
