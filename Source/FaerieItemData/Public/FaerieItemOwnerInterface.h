...
public:
	...
	// stack will contain a valid pointer and the amount of released copies. The returned stack size is guarenteed to be
	...
	// or none. Partial possession now allowed.
