...
public:
	virtual bool Exec(const UFaerieItemDataProxyBase* Proxy) const override { return true; }
};
...
public:
	...
	virtual bool Exec(const UFaerieItemDataProxyBase* Proxy) const override;
